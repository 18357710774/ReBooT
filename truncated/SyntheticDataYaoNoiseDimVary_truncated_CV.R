## Main function for the performance comparison of RTboosting on the high-cross data with changing number of noise dimensions
...
source(str_c(pathtmp, "truncated\\CVboosting_truncated.R")) # truncated boosting
