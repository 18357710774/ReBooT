## Main function for the performance comparison of LogitBoost on the dataset ACredit
...
while(tt<=t_num) # loops
{
  ...
  ada_results_IterOpt[[tt]] <- boosting_ada(train_x, train_y, test_x, test_y, iter_tmp=iterMax, control = control)
