CVboosting_ada_exp <- function(train_x, train_y,iter_tmp=500, control = rpart.control(cp = -1 , maxdepth = 1 , minsplit = 0), 
                          loss='e', nfolds = 5, parallel = FALSE, pathtmp, ...)
  
  ## Main function for cross-validation of AdaBoost algorithm
