"ada.machine.modification" <-
function(x,y,test.x,test.y,iter=50,nu=1,bag.frac=1,lossObj,C_t, ctype, lc,ltype,
  ...
  obj=list(trees=fit, alpha=alpha, rescale=rescale, F=ans, errs=errs, oob.str=list(oobm.err=oobm.err,oobm.mat=oobm.mat),
           lw=w,shift=shift,lossObj=lossObj)
