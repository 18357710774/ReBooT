## Main function for the performance comparison of LogitBoost on the high-cross data with changing number of noise dimensions
...
for (ii in 1:length(noise_feature_Cross)){
  ...
  file1 = str_c(pathtmp,"catboost\\results\\CAT_", dataName, "_CVSel_results_iterMax",
